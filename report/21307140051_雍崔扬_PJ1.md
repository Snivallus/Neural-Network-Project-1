...
姓名: 雍崔扬  
学号: 21307140051  
Github Repo: [Snivallus/Neural-Network-Project-1](https://github.com/Snivallus/Neural-Network-Project-1) (代码 + 模型文件)
...
(事实上，卷积神经网络的旋转不变性非常有限，但至少要优于前馈神经网络)
...
模型配置: (`code/saved_models/best_model_9.pickle`)
...
在验证集上的准确率为 $97.04\%$，在测试集上的准确率为 $97.06\%$.

![](training_curves_9.png)
